...
RSpec.describe "/api/v1/categories", type: :request do
  ...
  describe "POST /create" do
      ...
      it "creates a new Api::V1::Category" do
        expect {
          post api_v1_categories_url,
               params: { api_v1_category: valid_attributes }, headers: valid_headers, as: :json
        }.to change(Api::V1::Category, :count).by(1)
      end

      it "renders a JSON response with the new api_v1_category" do
        post api_v1_categories_url,
             params: { api_v1_category: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new api_v1_category" do
        post api_v1_categories_url,
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested api_v1_category" do
        category = Api::V1::Category.create! valid_attributes
      ...
      it "renders a JSON response with the api_v1_category" do
        category = Api::V1::Category.create! valid_attributes
        patch api_v1_category_url(category),
              params: { api_v1_category: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the api_v1_category" do
        category = Api::V1::Category.create! valid_attributes
        patch api_v1_category_url(category),
              params: { api_v1_category: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested api_v1_category" do
      category = Api::V1::Category.create! valid_attributes
      expect {
